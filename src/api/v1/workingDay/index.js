...
// SERVICES
const save = require("../../../services/workingDay/save");
const list = require("../../../services/workingDay/list");
const getDetails = require("../../../services/workingDay/getDetails");
const update = require("../../../services/workingDay/update");
const deleteDetails = require("../../../services/workingDay/delete");
