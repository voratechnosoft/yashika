...
// SERVICES
const save = require("../../../services/plainMeter/save");
const list = require("../../../services/plainMeter/list");
const getDetails = require("../../../services/plainMeter/getDetails");
const update = require("../../../services/plainMeter/update");
const deleteDetails = require("../../../services/plainMeter/delete");
