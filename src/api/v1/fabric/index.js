...
// SERVICES
const save = require("../../../services/fabric/save");
const list = require("../../../services/fabric/list");
const getDetails = require("../../../services/fabric/getDetails");
const update = require("../../../services/fabric/update");
const deleteDetails = require("../../../services/fabric/delete");
