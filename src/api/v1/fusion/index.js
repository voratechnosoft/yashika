...
// SERVICES
const save = require("../../../services/fusion/save");
const list = require("../../../services/fusion/list");
const getDetails = require("../../../services/fusion/getDetails");
const update = require("../../../services/fusion/update");
const deleteDetails = require("../../../services/fusion/delete");
